...
int main()
{
	...
	printf("########### UNIT TEST: BUG #9 ###########\n");
	printf("**Test: Unexpected gain in action cards from duplicate Tribute card reveal**\n\n");
	...
	G1.deck[player_2][0] = gold;
	G1.deck[player_2][1] = gold;
	...
	Validate("player 1 should gain 2 coins", G1.coins == G2.coins + 2);
